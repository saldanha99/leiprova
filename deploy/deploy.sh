...
docker compose build app migrate seed opportunity-approver legal-monitor editorial-automation editorial-operator editorial-draft-importer editorial-review-80 editorial-binding-importer
