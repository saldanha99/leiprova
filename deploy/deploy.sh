...
docker compose build app migrate seed opportunity-approver legal-monitor editorial-automation editorial-operator editorial-draft-importer editorial-review-80 editorial-binding-importer purchase-delivery
...
docker compose up -d --wait --wait-timeout 180 app legal-monitor editorial-automation purchase-delivery
docker compose ps
