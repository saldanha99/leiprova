...
export const RATE_LIMIT_POLICIES = {
  ...
  accessRequestIp: { scope: "auth_access_request_ip", limit: 10, windowSeconds: 60 * 60 },
  accessRequestEmail: { scope: "auth_access_request_email", limit: 3, windowSeconds: 60 * 60 },
