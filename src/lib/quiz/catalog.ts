...
export const quizCareerTracks = [
  {
    ...
    name: "Cartórios",
    shortName: "Cartórios",
    description: "Preparação para o ENAC e concursos estaduais de serventias extrajudiciais.",
    featured: false,
    specializations: [],
  ...
  },
  {
    slug: "policia-penal",
    name: "Polícia Penal",
    shortName: "Polícia Penal",
    description: "Trilhas por edição para os concursos das Polícias Penais estaduais e federal.",
    featured: false,
    specializations: [],
    subjectSlugs: corePublicSubjectSlugs,
  },
  {
    slug: "policia-rodoviaria-federal",
    name: "Polícia Rodoviária Federal",
    shortName: "PRF",
    description: "Preparação jurídica direcionada às edições da Polícia Rodoviária Federal.",
    featured: false,
    specializations: [],
    subjectSlugs: corePublicSubjectSlugs,
  },
  {
    slug: "procurador",
    name: "Procurador",
    shortName: "Procuradorias",
    description: "Preparação para Procuradorias estaduais, municipais e federais.",
    featured: false,
    specializations: [
      { slug: "estado", name: "Procurador do Estado" },
      { slug: "municipio", name: "Procurador do Município" },
      { slug: "federal", name: "Advocacia Pública Federal" },
    ],
    subjectSlugs: allSubjectSlugs,
  },
  {
    ...
    name: "Auditor Fiscal",
    shortName: "Fiscal",
    description: "Preparação por edital para administrações tributárias estaduais e municipais.",
    featured: false,
    specializations: [],
    subjectSlugs: [
      "direito-constitucional",
  ...
  },
  {
    ...
    shortName: "Controle",
    description: "Preparação para Tribunais de Contas, controladorias e auditorias públicas.",
    featured: false,
    specializations: [],
    subjectSlugs: [
      "direito-constitucional",
  ...
  },
  {
    ...
    shortName: "Legislativa",
    description: "Preparação para carreiras jurídicas e técnicas do Poder Legislativo.",
    featured: false,
    specializations: [],
    subjectSlugs: [
      "direito-constitucional",
