...
export const metadata: Metadata = {
  title: "Contato",
  description: "Canal de suporte e relato de inconsistências de conteúdo da LeiProva.",
  alternates: { canonical: "/contato" },
  robots: { index: false, follow: true, noarchive: true },
  openGraph: { url: "/contato", title: "Contato | LeiProva" },
};
