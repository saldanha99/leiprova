...
export default function PrivacyPage() {
  return (
    <LegalDocument title="Política de Privacidade" updatedAt="16 de agosto de 2026" notice="Documento da fase beta, pendente de revisão jurídica final. A identificação do controlador e o contato do encarregado aparecem preenchidos assim que publicados; até lá não há oferta comercial ativa.">
